<script>
    ...
    let isModal = false, like = false, bookmark = false;
...
<div class="Card">
  ...
  <div class="card-container">
      ...
      <div class="card-photo">
          <figure on:dblclick={ like == false && handleLike}>
      ...
      <div class="card-icons">
          ...
          <div class="card-icons-second">
              <i class="fas fa-bookmark active-bookmark" class:active-bookmark={bookmark} on:click={ () => (bookmark = !bookmark)}/>
          </div>
      </div>
